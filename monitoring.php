                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="row">
                                                            <div class="col">
                                                                <a href='monitoring/detail.php?id=<?php echo $row["transaksi_id"]; ?>' class="btn btn-info btn-block">Detail</a>
                                                            </div>
                                                            <div class="col">
                                                                <a href='monitoring/generate_pdf/pdf.php?id=<?php echo $row["transaksi_id"]; ?>' class="btn btn-block btn-outline-danger"><i class="fas fa-file-pdf" style="margin-right: 8px;"></i>PDF</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
